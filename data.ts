...
export const PROGETTI: Progetto[] = [
  {
    ...
    descrizione: 'Il film del 1987 di Don Paolo, restaurato quest\'estate, ci ha ridato le voci di persone che non ci sono più — le stiamo mappando tutte, volto per volto. Ora tocca a chi può ancora raccontare: trenta interviste all\'ultima generazione nata nelle borgate, la digitalizzazione delle foto di famiglia, le targhe permanenti del museo diffuso — inquadri il QR sul muro e senti chi abitava lì — e la restituzione al paese con mostra e camminata della memoria. Intanto la pilota corre: le prime case dei protagonisti sono georiferite nel gemello 3D e la camminata della memoria GPS fa già parlare il borgo a chi lo attraversa. Candidato all\'Avviso Richieste Libere 2026 della Fondazione di Modena (esito entro il 20 novembre).',
    azioni: ['30 interviste videoregistrate con formazione dei volontari alla storia orale', 'Digitalizzazione di foto e documenti di famiglia e ricerche d\'archivio', 'Targhe permanenti del museo diffuso nelle borgate e integrazione nel gemello 3D', 'Riprese aeree col drone e prima fotogrammetria del borgo', 'Mostra e camminata della memoria con i testimoni come narratori'],
    budgetMin: 13000, budgetMax: 13000, raccolti: 3000, stato: 'candidato a bando',
    fonti: 'Fondazione di Modena (richiesti 10.000 €), quote sociali, 5×1000, offerte agli eventi, sponsor locali',
    bando: {
      ...
      punti: [
        ...
        'Quanto: chiediamo 10.000 € su un costo totale di 13.000 € (IVA compresa), drone per le riprese aeree incluso. Il resto (3.000 €, il 23%) lo mettiamo noi con quote sociali, 5×1000, offerte e sponsor locali — il minimo richiesto era il 10%, stare oltre il doppio è un punto a favore.',
        ...
        'Come pagano: a consuntivo — prima si fanno le attività e si conservano le fatture, poi la Fondazione rimborsa fino a 10.000 €.',
        ...
        'Il nostro asso: la fase pilota è già fatta con mezzi nostri — film del 1987 restaurato, voci online, case dei protagonisti georiferite nel gemello 3D e camminata della memoria GPS già funzionante. Non promettiamo: mostriamo.',
      ],
    },
  },
  {
