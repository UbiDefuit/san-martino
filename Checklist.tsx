...
export const FASI: Fase[] = [
  ...
  {
    titolo: 'La spesa — confermare quantità e comprare', quando: 'dal foglio · spunta quando è preso',
    voci: [
      { id: 'sp-gramigna', t: 'Gramigna 8 kg (bianca e verde)', chi: 'Cucina', critica: true },
      { id: 'sp-salsiccia', t: 'Salsiccia 4 kg', chi: 'Cucina', critica: true },
      { id: 'sp-panna', t: 'Panna 4 L', chi: 'Cucina', critica: true },
      { id: 'sp-formaggio', t: 'Formaggio grattugiato 8 etti', chi: 'Cucina' },
      { id: 'sp-tigelle', t: 'Tigelle: 800 ordinate — confermare', chi: 'Piastra', critica: true },
      { id: 'sp-lardo', t: 'Lardo 9 vaschette', chi: 'Piastra' },
      { id: 'sp-prosciutto', t: 'Prosciutto — 20 vaschette? da confermare', chi: 'Piastra' },
      { id: 'sp-mortadella', t: 'Mortadella (Eurospin) 3-4', chi: 'Piastra' },
      { id: 'sp-salame', t: 'Salame 2 da 1 kg circa', chi: 'Piastra' },
      { id: 'sp-dolce', t: 'Nutella grande + crema e marmellata (Gabri)', chi: 'Piastra' },
      { id: 'sp-olio', t: 'Olio 10 L (arachidi o girasole)', chi: 'Frittura', critica: true },
      { id: 'sp-acqua-nat', t: 'Acqua naturale 4 pacchi da 6', chi: 'Bar' },
      { id: 'sp-acqua-friz', t: 'Acqua frizzante 3 pacchi da 6', chi: 'Bar' },
      { id: 'sp-birra', t: 'Birra 1 cassa — 18? da confermare', chi: 'Bar' },
      { id: 'sp-prosecco', t: 'Prosecco 1 cassa da 6', chi: 'Bar', critica: true },
      { id: 'sp-aperol', t: 'Aperol 1 bottiglia', chi: 'Bar', critica: true },
      { id: 'sp-gin', t: 'Gin 1 bottiglia', chi: 'Bar', critica: true },
      { id: 'sp-tonica', t: 'Tonica 3 L', chi: 'Bar' },
      { id: 'sp-ace', t: 'ACE 3 bottiglie grandi (per i bambini)', chi: 'Bar' },
      { id: 'sp-ghiaccio', t: 'Ghiaccio 6 buste', chi: 'Bar' },
      { id: 'sp-caffe', t: 'Cialde caffè A Modo Mio 1 pacco + 25 bicchierini', chi: 'Bar' },
      { id: 'sp-piatti', t: 'Plastica: 100 piatti fondi, 100 piani, 100 piattini', chi: 'Sala' },
      { id: 'sp-posate', t: 'Plastica: 100 forchette, 100 coltelli, 100 cucchiaini', chi: 'Sala' },
      { id: 'sp-bicchieri', t: 'Plastica: 100 bicchieri + 100 da cocktail + 100 cannucce', chi: 'Bar' },
      { id: 'sp-tovaglioli', t: 'Tovaglioli + 2 rotoli per asciugare le mani', chi: 'Sala' },
      { id: 'sp-contenitori', t: 'Contenitori da tavolo 40 — confermare numero', chi: 'Sala' },
      { id: 'sp-igienica', t: 'Carta igienica 4 rotoli', chi: 'Sala' },
    ],
  },
  {
