...
export const PROGETTI: Progetto[] = [
  {
    ...
    budgetMin: 12500, budgetMax: 12500, raccolti: 2500, stato: 'candidato a bando',
    fonti: 'Fondazione di Modena (richiesti 10.000 €), quote sociali, 5×1000, offerte agli eventi',
    bando: {
      ...
      punti: [
        ...
        'Quanto: chiediamo 10.000 € su un costo totale di 12.500 € (IVA compresa). Il resto (2.500 €, il 20%) lo mettiamo noi con quote sociali, 5×1000 e offerte — il minimo richiesto era il 10%, stare sopra è un punto a favore.',
